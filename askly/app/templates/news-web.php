...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <div class="list-group w-1">
      <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
        <img src="https://github.com/twbs.png" alt="twbs" width="32" height="32" class="rounded-circle flex-shrink-0">
        <div class="d-flex gap-2 w-100 justify-content-between">
          <div>
            <h6 class="mb-2">List group item heading</h6>
            <p class="mb-2 opacity-75">Some placeholder content in a paragraph.</p>
          </div>
      ...
      <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
        ...
        <div class="d-flex gap-2 w-100 justify-content-between">
          <div>
            <h6 class="mb-3">Another title here</h6>
            <p class="mb-1 opacity-75">Some placeholder content in a paragraph that goes a little longer so it wraps to a new line.</p>
          </div>
      ...
      <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
        ...
        <div class="d-flex gap-2 w-100 justify-content-between">
          <div>
            <h6 class="mb-1">Third heading</h6>
            <p class="mb-1 opacity-75">Some placeholder content in a paragraph.</p>
          </div>
